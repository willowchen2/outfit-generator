...
results=model.train(
    ...
    epochs=100, #number of trainign round/numbe rof times model looks at each image. higher numbers might lead ot overfitting
    ...
    device=0, #computer uses GPU for trianing claultions, instead of CPU or aother
